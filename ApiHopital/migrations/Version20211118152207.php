 ...
 */
final class Version20211118152207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, lit_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, lieu VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, probleme VARCHAR(255) NOT NULL, numero_ss INT NOT NULL, UNIQUE INDEX UNIQ_1ADAD7EBED5CA9E6 (service_id), UNIQUE INDEX UNIQ_1ADAD7EB278B5057 (lit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
